...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("1fileHW5_Seminar4.txt", create_str(koef1))
write_file("2fileHW5_Seminar4.txt", create_str(koef2))

# нахождение суммы многочлена

with open('1fileHW5_Seminar4.txt', 'r') as data:
    st1 = data.readlines()
with open('2fileHW5_Seminar4.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("fileHW5_Seminar4.txt", create_str(lst_new))
with open('fileHW5_Seminar4.txt', 'r') as data:
    st3 = data.readlines()
